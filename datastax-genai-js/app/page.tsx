    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <main className="text-center p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-4">
          Welcome to DataStax - Gen AI for JS Developers Workshop
        </h1>
        ...
        <div className="space-y-4">
          ...
          <a
            href="/langflow"
            className="block w-full py-3 bg-indigo-500 text-white font-semibold rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75"
          >
            Go to Langflow
          </a>
          <a
